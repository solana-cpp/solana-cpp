...
class FtxReferenceDataClientService : public boost::asio::execution_context::service
{
public:
    ...
    FtxReferenceDataClientImpl & impl( ) { return _impl; }
...
private:
    ...
    {
        SYNTHFI_LOG_DEBUG( _logger ) << "Shutting down FtxReferenceDataClientService";
    }
    ...
    FtxReferenceDataClientImpl _impl;
