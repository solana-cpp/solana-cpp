...
class FtxMarketDataClientService : public boost::asio::execution_context::service
{
public:
    ...
    (
        ...
        , _impl( _ioContext, ftxReferenceDataClientService, ftxWsClientService, statisticsPublisherService )
    { }
    ...
    FtxMarketDataClientImpl & impl( ) { return _impl; }
...
private:
    ...
    {
        SYNTHFI_LOG_DEBUG( _logger ) << "Shutting down FtxMarketDataClientService";
    }
