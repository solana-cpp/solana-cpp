...
#include "synthfi/Serum/SerumReferenceDataClient/SerumReferenceDataClientImpl.hpp"
...
class SerumReferenceDataClientService : public boost::asio::execution_context::service
{
public:
    ...
    SerumReferenceDataClientImpl & impl( ) { return _impl; }
...
private:
    ...
    SerumReferenceDataClientImpl _impl;
