...
class MangoOrderClientService : public boost::asio::execution_context::service
{
public:
    ...
    MangoOrderClientImpl & impl( ) { return _impl; }
...
private:
    ...
    {
        SYNTHFI_LOG_DEBUG( _logger ) << "Shutting down MangoOrderClientService";
    }
