...
class SolanaHttpClientService : public boost::asio::execution_context::service
{
public:
    ...
    SolanaHttpClientImpl & impl( ) { return _impl; }
...
private:
    ...
    {
        SYNTHFI_LOG_DEBUG( _logger ) << "Shutting down SolanaHttpClientService";
