...
class SlotSubscriberService : public boost::asio::execution_context::service
{
public:
    ...
    (
        ...
        , _subscriber( _ioContext, solanaHttpClientService, solanaWsClientService, statisticsPublisherService )
    { }
    ...
    SlotSubscriberImpl & subscriber( ) { return _subscriber; }
...
private:
    ...
    SlotSubscriberImpl _subscriber;
