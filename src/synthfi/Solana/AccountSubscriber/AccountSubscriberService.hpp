...
class AccountSubscriberService : public boost::asio::execution_context::service
{
public:
    ...
    AccountSubscriberImpl & subscriber( ) { return _subscriber; }
...
private:
    ...
    AccountSubscriberImpl _subscriber;
